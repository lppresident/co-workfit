...
class SettlementSummary {
  ...
  /// 만료된 챌린지 수
  final int expiredChallengeCount;
  ...
  const SettlementSummary({
    ...
    required this.expiredChallengeCount,
  ...
  factory SettlementSummary.fromSettlements(List<WoodSettlementEntity> settlements) {
    return SettlementSummary(
      ...
      expiredChallengeCount:
          settlements.fold(0, (sum, s) => sum + s.expiredChallenges.length),
  ...
  /// 만료된 챌린지가 있는지
  bool get hasExpiredChallenges => expiredChallengeCount > 0;
}
